...
export const generateMetadata = () => {
  return {
    ...
    description:
      "Phụ kiện xe VinFast 2025 chính hãng mới nhất: đầy đủ mẫu mã cho VF e34, VF 5, VF 6, VF 7, VF 8, VF 9... tại VinFast An Giang. Chất lượng đảm bảo, giá tốt, hỗ trợ lắp đặt chuyên nghiệp.",
    alternates: {
