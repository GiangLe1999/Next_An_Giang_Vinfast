...
export const generateMetadata = () => {
  return {
    ...
    description:
      "Tổng hợp tin tức mới nhất về VinFast: xe điện, công nghệ, chính sách bán hàng, chương trình khuyến mãi và sự kiện nổi bật. Cập nhật liên tục tại VinFast An Giang.",
    alternates: {
