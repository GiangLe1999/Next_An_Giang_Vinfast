...
export const generateMetadata = () => {
  return {
    ...
    description:
      "Công cụ tính phí lăn bánh xe VinFast giúp bạn ước tính chi phí chính xác bao gồm giá xe, thuế, phí trước bạ, đăng ký, bảo hiểm,... Cập nhật mới nhất tại VinFast An Giang.",
    alternates: {
