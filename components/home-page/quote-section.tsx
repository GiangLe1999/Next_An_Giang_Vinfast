          ...
          <div className="grid grid-cols-2 gap-3 max-[932px]:grid-cols-1">
            <div className="py-8 text-textColor space-y-6">
              ...
              <p className="text-justify">
                ...
                tại các tỉnh thành cũng như tại An Giang. Hiện tại, nếu biết giá
                lăn bánh cụ thể, đi kèm khuyến mãi hiện hành ở thời điểm quý
                khách đang xem như thể nào, xin mời quý khách liên hệ 0822 220
                088 ( Ghi chú: Giá xe Lăn Bánh có thể thay đổi tùy vào khu vực,
                tất cả chi phí trên chưa bao gồm phí dịch vụ làm biển số liên hệ
                để biết giá xe lăn bánh tại từng khu vực ).
              </p>
